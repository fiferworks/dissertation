...
<!-- This imports the first page of my pdf, you need the -0.5 cm offset to
avoid overlapping the chapter heading-->
\includepdf[pages=1,pagecommand=\chapter{\textit{Brevipalpus}-TRANSMITTED ORCHID FLECK VIRUS INFECTING THREE NEW ORNAMENTAL HOSTS IN FLORIDA}, scale=0.95, offset=0 -0.5cm]{pubs/ofv_brevi_report.pdf}
