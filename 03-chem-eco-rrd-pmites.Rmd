...
```{r qsep-vocs, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_qsep.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_qsep.png')
```

```{r qsep-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_qsep.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_qsep.png')
```

```{r qsep-vocs-scree, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_qsep.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_qsep.png')
```


```{r spme-vocs, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_spme.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_spme.png')
```

```{r spme-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_spme.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_spme.png')
```

```{r spme-vocs-scree, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_spme.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_spme.png')
```

```{r qsep-vocs-umap, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_qsep.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_qsep.png')
```

```{r spme-vocs-umap, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_spme.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_spme.png')
```


```{r qsep-vocs-umap-chems, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_qsep.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_chems_rrd_qsep.png')
```

```{r spme-vocs-umap-chems, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_spme.png'), fig.cap="beans.", out.width="80%", warning=FALSE}
