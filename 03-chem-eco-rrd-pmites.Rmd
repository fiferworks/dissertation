...
```{r voc-qsep, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/vol-extract-qsep.tif'), fig.cap="Volatile collection system for rose headspace sampling. An inert nylon bag is placed around the canes of interest, an air inlet is inserted and sealed at the base with a zip-tie to form a relatively air-tight seal around the base of the rose canes. Once the bag begins to inflate, a small hole is cut in the corner of the bag and a filter inserted and sealed with a zip-tie to form a second seal. The exterior end of the filter is attached to a vacuum airline set to allow for constant static pressure on the bag from inflation. The rose is then left for 24 hours, the filter is eluted with Dichloromethane into a gas chromatography vial, 1 \\si{\\micro\\liter} of Nonyl Acetate is added as an internal standard, and then the sample is processed using a coupled Gas Chromatography - Mass Spectrometer (GC-MS) for chemical identification.", out.width="80%", warning=FALSE}
grid::grid.raster(tiff::readTIFF('figure/vol-extract-qsep.tif'))
```

```{r voc-spme, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/vol-extract-spme.tif'), fig.cap="Volatile collection system for rose headspace sampling. An inert nylon bag is placed around the canes of interest, an air inlet is inserted and sealed at the base with a zip-tie to form a relatively air-tight seal around the base of the rose canes. Once the bag begins to inflate, a small hole is cut in the corner of the bag and a filter inserted and sealed with a zip-tie to form a second seal. 1 \\si{\\micro\\liter} of Nonyl Acetate is added as an internal standard, and then the sample is processed using a coupled GC-MS for chemical identification.", out.width="70%", warning=FALSE}
...
<!-- ####QSEP#### -->
```{r qsep-vocs, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_qsep.png'), fig.cap="PCA biplot of volatiles collected with VCT method.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_qsep.png')
```

```{r qsep-vocs-compares, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_qsep.png'), fig.cap="Comparison of VCT Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_qsep.png')
```

```{r qsep-vocs-scree, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_qsep.png'), fig.cap="Scree plot of VCT Principal Components", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_qsep.png')
```

```{r qsep-vocs-umap, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_qsep.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of VCT samples.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_qsep.png')
```

```{r qsep-vocs-umap-chems, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_qsep.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of VCT method's six largest contributions to volatile compositions.", out.width="100%", warning=FALSE}
...
<!-- ####SPME#### -->
```{r spme-vocs, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_spme.png'), fig.cap="PCA biplot of volatiles collected with SPME method.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_spme.png')
```

```{r spme-vocs-compares, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_spme.png'), fig.cap="Comparison of SPME Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_spme.png')
```

```{r spme-vocs-scree, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_spme.png'), fig.cap="Scree plot of SPME Principal Components", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_spme.png')
```

```{r spme-vocs-umap, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_spme.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of SPME method volatiles.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_spme.png')
```

```{r spme-vocs-umap-chems, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_spme.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of SPME method's six largest contributions to volatile compositions.", out.width="100%", warning=FALSE}
...
<!-- ####BOTH#### -->
```{r all-vocs, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_df.png'), fig.cap="PCA biplot of volatiles collected with VCT+SPME methods.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_df.png')
```

```{r all-vocs-compares, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_df.png'), fig.cap="Comparison of VCT+SPME Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_df.png')
```

```{r all-vocs-scree, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_df.png'), fig.cap="Scree plot of VCT+SPME Principal Components.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_df.png')
```

```{r all-vocs-umap, fig.height=8, fig.width=10.5, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_df.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of all VCT+SPME volatiles.", out.width="100%", warning=FALSE}
