...
```{r all-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_labeled_pca_comp_df.png'), fig.cap="Comparison of VCT+SPME Principal Components. Ellipses represent 95% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_labeled_pca_comp_df.png')
```
