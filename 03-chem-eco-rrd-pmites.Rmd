...
The top six contributing VOCs for VCT were \textgamma-Murrolene, \textbeta-Ocimene, (E,E)-\textalpha-Farnesene, \textbeta-Caryophyllene, Methyl Salicylate and \textbeta-Pinene (*\@ref(tab:qsep-contrib-table)*). The top six contributing chemicals for SPME were \textgamma-Murrolene,	\textbeta-Caryophyllene 1R-\textalpha-Pinene, Mesitylene, \textbeta-Pinene and m-Xylene (*\@ref(tab:spme-contrib-table)*). Roses infected with RRD were generally similar to uninfected roses for both VCT and SPME methods, but did (*\ref(fig:qsep-vocs-compares)*, *\ref(fig:spme-vocs-compares)*, *\@ref(fig:rrv_volatiles_umap_rrd_qsep.png)*, *\@ref(fig:rrv_volatiles_umap_rrd_spme.png)*), but ASM-treated roses had less chemical variance than either group (*\ref(fig:spme-vocs-compares)*, *\@ref(fig:rrv_volatiles_umap_rrd_spme.png)*). For VCT samples, \textgamma-Murrolene explained most of the variance in uninfected roses, while SPME samples showed the opposite:\textgamma-Murrolene and \textbeta-Caryophyllene were primarily found in infected roses.


<!-- ####QSEP#### -->
```{r qsep-vocs, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_qsep.png'), fig.cap="PCA biplot of volatiles collected with VCT method.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_qsep.png')
```

```{r qsep-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_qsep.png'), fig.cap="Comparison of VCT Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_qsep.png')
```

```{r qsep-vocs-scree, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_qsep.png'), fig.cap="Scree plot of VCT Principal Components", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_qsep.png')
```

```{r qsep-vocs-umap, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_qsep.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of VCT samples.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_qsep.png')
```

```{r qsep-vocs-umap-chems, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_qsep.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of VCT method's six largest contributions to volatile compositions.", out.width="100%", warning=FALSE}
...
<!-- ####SPME#### -->
```{r spme-vocs, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_spme.png'), fig.cap="PCA biplot of volatiles collected with SPME method.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_spme.png')
```

```{r spme-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_spme.png'), fig.cap="Comparison of SPME Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_spme.png')
```

```{r spme-vocs-scree, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_spme.png'), fig.cap="Scree plot of SPME Principal Components", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_spme.png')
```

```{r spme-vocs-umap, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_spme.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of SPME method volatiles.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_spme.png')
```

```{r spme-vocs-umap-chems, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_spme.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of SPME method's six largest contributions to volatile compositions.", out.width="100%", warning=FALSE}
...
<!-- ####BOTH#### -->
```{r all-vocs, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_df.png'), fig.cap="PCA biplot of volatiles collected with VCT+SPME methods.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_df.png')
```

```{r all-vocs-compares, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_df.png'), fig.cap="Comparison of VCT+SPME Principal Components. Ellipses represent 95\\% confidence intervals.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_df.png')
```

```{r all-vocs-scree, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_df.png'), fig.cap="Scree plot of VCT+SPME Principal Components.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_df.png')
```

```{r all-vocs-umap, fig.height=8, fig.width=10.5, fig.align="center", out.extra='angle=90', cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_df.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of all VCT+SPME volatiles.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_chems_df.png')
```

```{r all-contrib-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_contribution_table_pca_dat.csv'), caption = "\\label{tab:all-contrib-table}"}
read_csv('data/rrv_volatiles_contribution_table_pca_dat.csv', show_col_types = FALSE) %>% 
knitr::kable(format = "latex", booktabs = TRUE, caption = "Contribution table for PCA of headspace VOCs collected with VCT+SPME methods from Pink Double Knock Out® roses.") %>%
  kable_styling(latex_options = c("striped", "scale_down", full_width = TRUE))
# %>%
#   footnote(general = "beans.")
...
```{r all-corr-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_correlation_table_pca_dat.csv'), caption = "\\label{tab:all-corr-table}"}
read_csv('data/rrv_volatiles_correlation_table_pca_dat.csv', show_col_types = FALSE) %>% 
knitr::kable(format = "latex", booktabs = TRUE, caption = "Correlation table for PCA of headspace VOCs collected with VCT+SPME methods from Pink Double Knock Out® roses.") %>%
  kable_styling(latex_options = c("striped", "scale_down", full_width = TRUE))
# %>%
#   footnote(general = "beans.")
