...
<!-- ####QSEP#### -->
```{r qsep-vocs, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_qsep.png'), fig.cap="Principal component analysis (PCA) biplot of volatiles collected with VCT method.", fig.scap="Principal component analysis (PCA) biplot of volatiles collected with VCT", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_qsep.png')
```

```{r qsep-vocs-compares, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_qsep.png'), fig.cap="Comparison of VCT principal components. Ellipses represent 95\\% confidence intervals.", fig.scap="Comparison of VCT principal components", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_qsep.png')
```

```{r qsep-vocs-scree, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_qsep.png'), fig.cap="Scree plot of VCT principal components.", fig.scap="Scree plot of VCT principal components", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_qsep.png')
```

```{r qsep-vocs-umap, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_qsep.png'), fig.cap="Uniform Manifold Approximation and Projection (UMAP) of VCT samples.", fig.scap="Uniform Manifold Approximation and Projection (UMAP) of VCT samples", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_qsep.png')
```

```{r qsep-vocs-umap-chems, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_qsep.png'), fig.cap="UMAP of VCT method's six largest contributions to volatile compositions.", fig.scap="UMAP of VCT method's six largest contributions to volatile compositions", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_chems_rrd_qsep.png')
```

```{r qsep-contrib-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_contribution_table_pca_dat_qsep.csv'), caption = "\\label{tab:qsep-contrib-table}"}
...
```{r qsep-corr-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_correlation_table_pca_dat_qsep.csv'), caption = "\\label{tab:qsep-corr-table}"}
...
<!-- ####SPME#### -->
```{r spme-vocs, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_spme.png'), fig.cap="PCA biplot of volatiles collected with SPME method.", fig.scap="PCA biplot of volatiles collected with SPME", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_spme.png')
```

```{r spme-vocs-compares, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_spme.png'), fig.cap="Comparison of SPME principal components. Ellipses represent 95\\% confidence intervals.", fig.scap="Comparison of SPME principal components", warning=FALSE}
...
```{r spme-vocs-umap, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_rrd_spme.png'), fig.cap="UMAP of SPME method volatiles.", fig.scap="UMAP of SPME method volatiles", warning=FALSE}
knitr::include_graphics('figure/rrv_volatiles_umap_rrd_spme.png')
```

```{r spme-vocs-umap-chems, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_rrd_spme.png'), fig.cap="UMAP of SPME method's six largest contributions to volatile compositions.", fig.scap="UMAP of SPME method's six largest contributions to volatile compositions", warning=FALSE}
...
<!-- <!-- ####BOTH#### --> -->
<!-- ```{r all-vocs, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_biplot_var_pca_df.png'), fig.cap="PCA biplot of volatiles collected with VCT+SPME methods.", fig.scap="PCA biplot of volatiles collected with VCT+SPME methods", warning=FALSE} -->
<!-- knitr::include_graphics('figure/rrv_volatiles_biplot_var_pca_df.png') -->
<!-- ``` -->

<!-- ```{r all-vocs-compares, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_comparison_pca_comp_df.png'), fig.cap="Comparison of VCT+SPME principal components. Ellipses represent 95\\% confidence intervals.", fig.scap="Comparison of VCT+SPME principal components", warning=FALSE} -->
<!-- knitr::include_graphics('figure/rrv_volatiles_comparison_pca_comp_df.png') -->
<!-- ``` -->

<!-- ```{r all-vocs-scree, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_screeplot_pca_df.png'), fig.cap="Scree plot of VCT+SPME principal components.", fig.scap="Scree plot of VCT+SPME principal components", warning=FALSE} -->
<!-- knitr::include_graphics('figure/rrv_volatiles_screeplot_pca_df.png') -->
<!-- ``` -->

<!-- ```{r all-vocs-umap, cache = TRUE, cache.extra = file.mtime('figure/rrv_volatiles_umap_chems_df.png'), fig.cap="UMAP of all VCT+SPME volatiles.", fig.scap="UMAP of all VCT+SPME volatiles", warning=FALSE} -->
<!-- knitr::include_graphics('figure/rrv_volatiles_umap_chems_df.png') -->
<!-- ``` -->

<!-- \clearpage -->
<!-- ```{r all-contrib-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_contribution_table_pca_dat.csv'),} -->
...
<!--       "striped", -->
<!--       "repeat_header", -->
<!--       repeat_header_continued = "Continued", -->
...
<!-- \clearpage -->
<!-- ```{r all-corr-table, echo = FALSE, warning = FALSE, cache = TRUE, cache.extra = file.mtime('data/rrv_volatiles_correlation_table_pca_dat.csv')} -->
...
<!--       "striped", -->
<!--       "repeat_header", -->
<!--       repeat_header_text = "\\textit{(Beans)}", -->
<!--       repeat_header_method = "replace", -->
<!--       full_width = TRUE -->
<!--     ) -->
<!--   ) -->
...
### *Amblyseius swirskii* were not affected by the VOCs tested
