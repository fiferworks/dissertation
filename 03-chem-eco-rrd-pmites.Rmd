...
```{r, fig.height=8, fig.width=10.5, fig.align="center", fig.cap = "*Amblyseius swirskii* attraction to healthy and Rose Rosette Virus-infected Pink Double Knock Out® roses. Asterisks represent significant differences as calculated by &chi;-squared contingency table tests for given probabilities. N.S. = not significant. RRV-infected vs Healthy Rose: &chi;-squared = 9.33, df = 1, α = 0.05, p-value = 0.002. Filtered Air vs Healthy Rose: &chi;-squared = 0.47, df = 1, α = 0.05, p-value = 0.4913.", out.width="80%", warning=FALSE}
