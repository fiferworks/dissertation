...
**Mites**
Potted plants were inoculated with putatively *P.fructiphilus*-infested canes from nearby RRD-infected roses in the landscape. Rose canes were placed onto potted roses during the first and fifth weeks of the experiment.
...
**Treatments**
Actigard50WG® (Syngenta AG, Basel, Switzerland), (acibenzolar-S-methyl, ASM) was applied at two different rates: 50 \si{\milli\gram}/\si{\liter} (Half rate) and 100 \si{\milli\gram}/\si{\liter} (High rate) to observe the effects of inducing Systemic Acquired Resistance (SAR) on *P. fructiphilus* 
