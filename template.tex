...
\newpage                         % Since the abstract needs to be a phantom chapter, we need to force a newpage.
    ...
    \label{abstract}
        \begin{center}\realSingleSpace
            ...
            % \MakeUppercase{$title$}\\[\baselineskip] % use this line if your title doesn't have scientific names
                                                       % otherwise, type it out and italicize as necessary
...
\docBodyfalse                    % you can add as many chapters as you need


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% APPENDICES                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
$if(appendix)$                   % If you have multiple appendices, add them as new chapters in the
  $appendix$                     % prelims/99--appendix file and edit the chapter headings to say 'APPENDIX A'
$endif$                          % 'APPENDIX B' and so on
...
% look at file 99-references to see the code
% that imports the text or to delete this section
