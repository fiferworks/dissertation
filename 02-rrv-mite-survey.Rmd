...
```{r survey_map_1, fig.height=8, fig.width=10.5, fig.align="center", fig.cap = "*P. fructiphilus* mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_fl_pf.png')
```


```{r survey_map_2, fig.height=8, fig.width=10.5, fig.align="center", fig.cap= "Other mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
...
```{r survey_map_3, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Location of populations of eriophyoid mites found on roses in northern Florida 2018-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_pf.png')
```


```{r survey_map_4, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Locations of other mites recovered during surveys of roses in Florida, 2018-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_others.png')
```

\pagebreak

```{r survey_table_1, echo = FALSE, warning = FALSE, caption = "Eriophyids and other mites recovered during surveys of roses in Florida, 2017-2021."}
df_fl <-
...
df_fl <- df_fl %>% select(-pfruct)
df_fl <- df_fl %>% filter(Year != 2017) %>% group_by(Year) %>% arrange(.by_group = TRUE)
...
```{r pheno_graphs, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Phenology of *P. fructiphilus* mite populations on roses in Leon County, Florida 2020-2021. Roses were pruned back heavily on July 9, 2020.", out.width="100%", warning=FALSE}
