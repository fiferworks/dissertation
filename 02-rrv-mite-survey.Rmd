...
```{r survey-map-1, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_fl_pf.png'), fig.cap = "\\textit{P. fructiphilus} mites recovered during surveys of roses in Florida, 2017-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_fl_pf.png')
```

\newpage

```{r survey-map-2, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_fl_other.png'), fig.cap= "Other mites recovered during surveys of roses in Florida, 2017-2021.", out.width="100%", warning=FALSE}
