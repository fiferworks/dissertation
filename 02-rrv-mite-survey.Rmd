...
```{r survey-table-1, echo = FALSE, warning = FALSE, results='asis', caption = "\\label{tab:survey-table-1}Eriophyids and other mites recovered during surveys of roses in Florida, 2017-2021."}
df_fl <-
