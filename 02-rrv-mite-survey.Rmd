...
```{r survey_map_3, fig.height=8, fig.width=10.5, fig.align="center", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_pf.png')
```
`r fig_nums(name = "survey_map_3", caption = "Location of populations of eriophyoid mites found on roses in northern Florida 2018-2021.")`

```{r survey_map_4, fig.height=8, fig.width=10.5, fig.align="center", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_others.png')
```
`r fig_nums(name = "survey_map_4", caption = "Locations of other mites recovered during surveys of roses in Florida, 2018-2021.")`
...
```{r pheno_graphs, fig.height=8, fig.width=10.5, fig.align="center", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_pheno_bargraph.png')
```
`r fig_nums(name = "pheno_graphs", caption = "Phenology of *P. fructiphilus* mite populations on roses in Leon County, Florida 2020-2021. Roses were pruned back heavily on July 9, 2020.")`
