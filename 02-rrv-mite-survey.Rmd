...
```{r survey-map-1, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_fl_pf.png'), fig.cap = "\\textit{P. fructiphilus} mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_fl_pf.png')
```

\newpage

```{r survey-map-2, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_fl_other.png'), fig.cap= "Other mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
...
```{r survey-map-3, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_years_pf.png'), fig.cap="Location of populations of eriophyoid mites found on roses in northern Florida 2018-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_pf.png')
```

\newpage

```{r survey-map-4, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_survey_map_years_others.png'), fig.cap="Locations of other mites recovered during surveys of roses in Florida, 2018-2021.", out.width="100%", warning=FALSE}
...
# %>%
#   footnote(general = "Eriophyids and other mites recovered during surveys of roses in Florida, 2017-2021.")

```
\newpage

### Phenology {#results-pheno}
Populations of *P. fructiphilius* showed seasonal fluctuations in mite numbers, with highest populations achieved during June 2020. Rose pruning reduced the numbers of *P, fructiphilus* until populations began to recover that November. Mite numbers remained relatively lower during 2021 compared to the previous year. None of the mite-infested roses have shown symptoms of RRD to date.

```{r pheno-graphs, fig.height=8, fig.width=10.5, fig.align="center", cache = TRUE, cache.extra = file.mtime('figure/rrv_pheno_bargraph.png'), fig.cap="Phenology of \\textit{P. fructiphilus} mite populations on roses in Leon County, Florida 2020-2021. Roses were pruned back heavily on July 9, 2020.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_pheno_bargraph.png')
```


## Discussion {#dis-survey-pheno}
The presence of *P. fructiphilus* in northern Florida over multiple years and seasons provides evidence against a putative southern limit for the species [@Solo2020].

Although a large number of other mites have been collected, it is beyond our ability to identify them many of them to species. Phytoseiid mites require expert identification, and many species have been misidentified either through carelessness or ignorance of the identifier [@Demard2021].

The large reductions of *P. fructiphilus* seen post pruning suggests its potential as a method of cultural mite control.
