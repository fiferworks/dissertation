...
```{r survey_map_3, fig.height=8, fig.width=10.5, fig.align="center", out.width="85%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_pf.png')
```
`r fig_nums(name = "survey_map_3", caption = "*P. fructiphilus* recovered during surveys of roses in Florida.")`

```{r survey_map_4, fig.height=8, fig.width=10.5, fig.align="center", out.width="85%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_others.png')
```
`r fig_nums(name = "survey_map_4", caption = "Other mites recovered during surveys of roses in Florida.")`
