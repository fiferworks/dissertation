...
```{r survey-map-1, fig.height=8, fig.width=10.5, fig.align="center", fig.cap = "\\textit{P. fructiphilus} mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_fl_pf.png')
```

\newpage

```{r survey-map-2, fig.height=8, fig.width=10.5, fig.align="center", fig.cap= "Other mites recovered during surveys of roses in Florida, 2017-2021.", out.width="85%", warning=FALSE}
...
```{r survey-map-3, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Location of populations of eriophyoid mites found on roses in northern Florida 2018-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_pf.png')
```

\newpage

```{r survey-map-4, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Locations of other mites recovered during surveys of roses in Florida, 2018-2021.", out.width="100%", warning=FALSE}
knitr::include_graphics('figure/rrv_survey_map_years_others.png')
```

\newpage

```{r survey-table-1, echo = FALSE, warning = FALSE}
df_fl <-
...
knitr::kable(format = "latex", booktabs = TRUE, caption = "\\label{tab:survey-table-1}Eriophyids and other mites recovered during surveys of roses in Florida, 2017-2021.") %>%
...
```{r pheno-graphs, fig.height=8, fig.width=10.5, fig.align="center", fig.cap="Phenology of \\textit{P. fructiphilus} mite populations on roses in Leon County, Florida 2020-2021. Roses were pruned back heavily on July 9, 2020.", out.width="100%", warning=FALSE}
