...
Eriophyoid mites were detected in *Phyllocoptes fructiphilus*
...
```{r survey_map_1, fig.height=8, fig.width=10.5, fig.align="center", out.width="80%", warning=FALSE}
...
```{r survey_map_2, fig.height=8, fig.width=10.5, fig.align="center", out.width="80%", warning=FALSE}
...
Although a large number of other mites have been collected, it is beyond our expertise to identify them to species. Phytoseiid mites require expert identification, and many species have been misidentified [@Demard2021].
