...
<!-- Phytoseiid mites require expert identification, and many species have been misidentified [@Demard2021] -->
...
```{r, surveymaps, fig.height=8, fig.width=10.5, fig.align="center", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/reed.jpg')
```
...
```{r, graphs, fig.height=8, fig.width=10.5, fig.align="center", out.width="80%", warning=FALSE}
knitr::include_graphics('figure/reed.jpg')
```
