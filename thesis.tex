...
\usepackage{lscape}
%\usepackage{hanging}
%\usepackage{longtable} %package clash?
\usepackage{amsfonts}
\usepackage{textcomp}
...
\chair{Xavier Martini, Mathews Paret}
