...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{center}
        \thispagestyle{empty}%
        \vspace*{-0.4in}\realSingleSpace{\MakeUppercase{Mite-Virus-Plant Complexes of Importance for Florida Agriculture: \emph{Phyllocoptes fructiphilus} and \emph{Brevipalpus californicus}}}%
        \vfill%
        By \\*[\baselineskip]%
...
\newpage                         % Since the abstract needs to be a phantom chapter, we need to force a newpage.
    ...
    \label{abstract}
        \begin{center}\realSingleSpace
            ...
            \MakeUppercase{Mite-Virus-Plant Complexes of Importance for Florida Agriculture: \emph{Phyllocoptes fructiphilus} and \emph{Brevipalpus californicus}}\\[\baselineskip]
            By\\[\baselineskip]
...
\hypertarget{phyllocoptes-fructiphilus-the-vector-of-rose-rosette-emaravirus-the-causal-agent-of-rose-rosette-disease-rrd}{%
\subsection{\texorpdfstring{\emph{Phyllocoptes fructiphilus}: the vector of \emph{Rose rosette emaravirus}, the causal agent of Rose Rosette Disease (RRD)}{Phyllocoptes fructiphilus: the vector of Rose rosette emaravirus, the causal agent of Rose Rosette Disease (RRD)}}\label{phyllocoptes-fructiphilus-the-vector-of-rose-rosette-emaravirus-the-causal-agent-of-rose-rosette-disease-rrd}}
...
\end{figure}
\hypertarget{current-management-of-rrd-is-not-effective}{%
\subsection{Current management of RRD is not effective}\label{current-management-of-rrd-is-not-effective}}
...
\hypertarget{can-systemic-acquired-resistance-reduce-mite-herbivory}{%
\section{Can Systemic Acquired Resistance Reduce Mite Herbivory?}\label{can-systemic-acquired-resistance-reduce-mite-herbivory}}
...
\end{figure}
\hypertarget{surveying-for-phyllocoptes-fructiphilus-rrd-and-predatory-mites-in-northern-florida}{%
\section{\texorpdfstring{Surveying for \emph{Phyllocoptes fructiphilus}, RRD and Predatory Mites in Northern Florida}{Surveying for Phyllocoptes fructiphilus, RRD and Predatory Mites in Northern Florida}}\label{surveying-for-phyllocoptes-fructiphilus-rrd-and-predatory-mites-in-northern-florida}}
...
\hypertarget{changes-in-headspace-volatiles-for-rrd-infected-roses}{%
\chapter{CHANGES IN HEADSPACE VOLATILES FOR RRD-INFECTED ROSES}\label{changes-in-headspace-volatiles-for-rrd-infected-roses}}

\hypertarget{introduction-1}{%
\section{Introduction}\label{introduction-1}}

\hypertarget{plant-defenses-and-volatiles-why-are-amblyseius-swirskii-attracted-to-rrd-infected-roses}{%
\subsection{\texorpdfstring{Plant defenses and volatiles: why are \emph{Amblyseius swirskii} attracted to RRD-infected roses?}{Plant defenses and volatiles: why are Amblyseius swirskii attracted to RRD-infected roses?}}\label{plant-defenses-and-volatiles-why-are-amblyseius-swirskii-attracted-to-rrd-infected-roses}}
...
\hypertarget{volatiles-differ-between-rrd-infected-uninfected-and-sar-induced-roses}{%
\subsection{Volatiles differ between RRD-infected, uninfected and SAR-induced roses}\label{volatiles-differ-between-rrd-infected-uninfected-and-sar-induced-roses}}
...
\hypertarget{management-of-phyllocoptes-fructiphilus-with-systemic-acquired-resistance}{%
\chapter{\texorpdfstring{MANAGEMENT OF \emph{PHYLLOCOPTES FRUCTIPHILUS} WITH SYSTEMIC ACQUIRED RESISTANCE}{MANAGEMENT OF PHYLLOCOPTES FRUCTIPHILUS WITH SYSTEMIC ACQUIRED RESISTANCE}}\label{management-of-phyllocoptes-fructiphilus-with-systemic-acquired-resistance}}
...
\hypertarget{integrating-pest-management-what-are-the-effects-of-systemic-acquired-resistance-sar-on-amblyseius-swirskii-and-phyllocoptes-fructiphilus}{%
\subsection{\texorpdfstring{Integrating pest management: what are the effects of systemic acquired resistance (SAR) on \emph{Amblyseius swirskii} and \emph{Phyllocoptes fructiphilus}?}{Integrating pest management: what are the effects of systemic acquired resistance (SAR) on Amblyseius swirskii and Phyllocoptes fructiphilus?}}\label{integrating-pest-management-what-are-the-effects-of-systemic-acquired-resistance-sar-on-amblyseius-swirskii-and-phyllocoptes-fructiphilus}}
...
\hypertarget{sar-induction-with-acibenzolar-s-methyl-asm-to-reduce-populations-of-phyllocoptes-fructiphilus}{%
\subsection{\texorpdfstring{SAR-induction with acibenzolar-S-methyl (ASM) to reduce populations of \emph{Phyllocoptes fructiphilus}}{SAR-induction with acibenzolar-S-methyl (ASM) to reduce populations of Phyllocoptes fructiphilus}}\label{sar-induction-with-acibenzolar-s-methyl-asm-to-reduce-populations-of-phyllocoptes-fructiphilus}}
