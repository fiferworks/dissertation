...
%this adds a header which says 'CHAPTER' to the toc
  ...
  Tenuipalpids have been studied much less than the Tetranychidae (Childers et al. 2003a)
  Not many methods of control have been reported (Jeppson et al. 1975, Gerson 2008)

  (Childers and Derrick 2003)

  Phytoseiid mites and water tested for their ability to reduce populations of \emph{B. obovatus} (Zheng et al. 2012).

  \emph{Raoiella indica} Hirst

  \emph{B. bassiana} has been tested to control \emph{R. indica}, and is potentially compatible with the previously-tested phytoseiid species \emph{Amblyseius largoensis} and \emph{Typhlodromus ornatus} (Carrillo and Peña 2011, Freitas et al. 2021).

  \emph{R. indica} has been quickly spreading and has the potential to establish in large parts of Brazil (Amaro et al. 2021).
