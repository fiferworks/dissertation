...
%this adds a header which says 'CHAPTER' to the toc
  ...
  The low number of \emph{A. swirskii} mites recovered may indicate that \emph{A. swirskii} do not persist in the rose environment, or are otherwise not surviving. Some evidence has been given that slow release sachets which are sheltered and provided with felt patches and and moisture in the form of water-absorbant sodium polyacrylate gels had better releases of predators (\protect\hyperlink{ref-Shimoda2018}{Shimoda et al. 2018}). In addition, other studies have struggled to recover phytoseiid mites generally, as evidenced by our mite surveys on roses.
