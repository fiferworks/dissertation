...
%this adds a header which says 'CHAPTER' to the toc
  ...
  \caption{IPM trials on Pink Double Knock Out® roses to control \textit{P. fructiphilus} in Athens and Griffin, GA with five treatments}\label{fig:ipm}
  \end{figure}
  \begin{figure}
  ...
  \caption{IPM trials on Pink Double Knock Out® roses to control \textit{P. fructiphilus} in Tallahassee, FL with five treatments}\label{fig:ipm-talla-erios-week}
  \end{figure}
  \begin{figure}
  ...
  \caption{IPM trials on Pink Double Knock Out® roses to control \textit{P. fructiphilus} in Tallahassee, FL with five treatments}\label{fig:ipm-talla-other}
  \end{figure}
