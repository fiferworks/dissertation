...
%this adds a header which says 'CHAPTER' to the toc
  ...
  We tested ASM alongside a different a SAR-inducer (SP2700, Trade name `Ninja', SePro) and combined one of the SAR-inducers with predatory mites to observe any synergistic effects. We used an acaricide as a negative control and water as a positive control. (see \emph{\ref{fig:ipm-talla-erios}}).
  ...
  Combining predatory mites with a SAR-inducer was as effective as the miticide alone, and controlled herbivorous mite populations more than either SAR-induction or predatory mites alone (see \emph{\ref{fig:ipm-talla-erios}}).
  \begin{figure}
