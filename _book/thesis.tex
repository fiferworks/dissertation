...
%this adds a header which says 'CHAPTER' to the toc
  ...
  The top six contributing VOCs for VCT were \textgamma-Murrolene, \textbeta-Ocimene, (E,E)-\textalpha-Farnesene, \textbeta-Caryophyllene, Methyl Salicylate and \textbeta-Pinene (\emph{\ref{tab:qsep-contrib-table}}). The top six contributing chemicals for SPME were \textgamma-Murrolene, \textbeta-Caryophyllene 1R-\textalpha-Pinene, Mesitylene, \textbeta-Pinene and m-Xylene (\emph{\ref{tab:spme-contrib-table}}). Roses infected with RRD were generally similar to uninfected roses for both VCT and SPME methods, but did (\emph{\ref(fig:qsep-vocs-compares) \ref(fig:spme-vocs-compares), @ref(fig:rrv\_volatiles\_umap\_rrd\_qsep.png), @ref(fig:rrv\_volatiles\_umap\_rrd\_spme.png)}), but ASM-treated roses had less chemical variance than either group (\emph{\ref(fig:spme-vocs-compares), @ref(fig:rrv\_volatiles\_umap\_rrd\_spme.png)}). For VCT samples, \textgamma-Murrolene explained most of the variance in uninfected roses, while SPME samples showed the opposite:\textgamma-Murrolene and \textbeta-Caryophyllene were primarily found in infected roses.
  \begin{figure}
  ...
  \textbackslash caption\{Comparison of VCT Principal Components. Ellipses represent 95\% confidence intervals.\}\label{fig:qsep-vocs-compares}
  ...
  \textbackslash caption\{Comparison of SPME Principal Components. Ellipses represent 95\% confidence intervals.\}\label{fig:spme-vocs-compares}
  \textbackslash end\{figure\}
  \begin{figure}
  ...
  {\centering \includegraphics[width=1\linewidth,angle=90]{figure/rrv_volatiles_biplot_var_pca_df} 
  ...
  \{\centering \includegraphics[width=1\linewidth,angle=90]{figure/rrv_volatiles_comparison_labeled_pca_comp_df}

  \}

  \textbackslash caption\{Comparison of VCT+SPME Principal Components. Ellipses represent 95\% confidence intervals.\}\label{fig:all-vocs-compares}
  \textbackslash end\{figure\}
  \begin{figure}

  {\centering \includegraphics[width=1\linewidth,angle=90]{figure/rrv_volatiles_screeplot_pca_df} 
  ...
  {\centering \includegraphics[width=1\linewidth,angle=90]{figure/rrv_volatiles_umap_chems_df} 
