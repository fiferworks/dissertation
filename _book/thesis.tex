...
%this adds a header which says 'CHAPTER' to the toc
  ...
  \hypertarget{integrating-management-tools-to-control-p.-fructiphilus}{%
  \subsection{\texorpdfstring{Integrating management tools to control \emph{P. fructiphilus}}{Integrating management tools to control P. fructiphilus}}\label{integrating-management-tools-to-control-p.-fructiphilus}}
