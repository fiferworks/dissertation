...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{center}
        \thispagestyle{empty}%
        \vspace*{-0.4in}\realSingleSpace{\MakeUppercase{Detection of Two Mite-Plant-Virus Pathosystems in Florida, Including Field Studies and Chemical Ecology of Induced Plant Defenses on \emph{Phyllocoptes fructiphilus} and \emph{Amblyseius swirskii}}}%
        \vfill%
        By \\*[\baselineskip]%
...
\newpage                         % Since the abstract needs to be a phantom chapter, we need to force a newpage.
    ...
    \label{abstract}
        \begin{center}\realSingleSpace
            ...
            \MakeUppercase{Detection of Two Mite-Plant-Virus Pathosystems in Florida, Including Field Studies and Chemical Ecology of Induced Plant Defenses on \emph{Phyllocoptes fructiphilus} and \emph{Amblyseius swirskii}}\\[\baselineskip]
            By\\[\baselineskip]
