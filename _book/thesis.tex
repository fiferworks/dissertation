...
%this adds a header which says 'CHAPTER' to the toc
  ...
  \hypertarget{coevolved-plant-specialists-the-eriophyoidea-erios-litrev}{%
  \section{Coevolved Plant Specialists: The Eriophyoidea \{erios-litrev\}}\label{coevolved-plant-specialists-the-eriophyoidea-erios-litrev}}
  ...
  \subsection{\texorpdfstring{\emph{P. fructiphilus} acts as the vector of Rose Rosette Virus, the causal agent of Rose Rosette Disease}{P. fructiphilus acts as the vector of Rose Rosette Virus, the causal agent of Rose Rosette Disease}}\label{pfruct-rrd-litrev}}
  ...
  \begin{center}\includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/symptoms-1} \end{center}
  ...
  \hypertarget{phytoseiids-mites-good-options-for-biological-control-ipm-preds-litrev}{%
  \subsection{Phytoseiids mites: good options for biological control \{ipm-preds-litrev\}}\label{phytoseiids-mites-good-options-for-biological-control-ipm-preds-litrev}}

  Many mites species have potential as a biological control (Gerson et al. 2003, Carrillo et al. 2015). Their efficiency as predators of pest species has been recognized for many years: One of the earliest recorded attempts at biological control was of a mite \emph{Tyroglyphus phylloxerae} (Riley \& Planchon), which was imported to France from the USA in an attempt to control the grape phylloxera, \emph{Daktulosphaira vitifoliae} (Fitch 1855) (Riley 1874, Dent 2000, Kirchmair et al. 2009). Although this early attempt was unsuccessful, several mite species have been successful in controlling pest species (Bellows Jr et al. 1996, Driesche et al. 2010). The most well-studied species of predatory mites used for biological is the Phytoseiidae (Gerson et al. 2003, Pérez et al. 2010, Carrillo et al. 2015). The lifecycles of Phytoseiid mites have been studied to develop methods for mass-rearing and releasing as biological control of thrips, whiteflies, spider mites (Tetranychidae), scale insects and other pests (Gerson et al. 2003, Sarwar 2017). Phytoseiid mites integrate well into pest management programs and are compatible with certain pesticides (Trumble and Morse 1993, Nicetic et al. 2001, Fernández et al. 2017) and other biocontrol agents (Midthassel et al. 2016).

  \hypertarget{amblyseius-swirskii-acari-parasitiformes-mesostigmata-ascoidea-phytoseiidae-for-biocontrol}{%
  \subsection{\texorpdfstring{\emph{Amblyseius swirskii} (Acari: Parasitiformes: Mesostigmata: Ascoidea: Phytoseiidae) for biocontrol}{Amblyseius swirskii (Acari: Parasitiformes: Mesostigmata: Ascoidea: Phytoseiidae) for biocontrol}}\label{amblyseius-swirskii-acari-parasitiformes-mesostigmata-ascoidea-phytoseiidae-for-biocontrol}}

  \emph{Amblyseius swirskii} Athias-Henriot have been used successfully in agriculture for pest control (Buitenhuis et al. 2015). \emph{A. swirskii} are generalist predators which feed on other common agricultural pests such as whiteflies (Bolckmans et al. 2005), spider mites (McMurtry et al. 1970), rust mites (Onzo et al. 2012), and thrips (Wimmer et al. 2008). \emph{A. swirskii} can persist on pollen (Loughner et al. 2011, Delisle et al. 2015) and other arthropods even when the pest of concern is absent (Janssen and Sabelis 2015). This allows \emph{A. swirskii} to be released as a preventative measure instead of reacting to an outbreak (Kutuk and Yigit 2011).

  These features make \emph{A. swirskii} an interesting option for managing \emph{P. fructiphilus}, but their potential has not yet been tested.
  ...
  \hypertarget{plant-defenses-and-systemic-acquires-resistance-sar-sar-litrev}{%
  \section{Plant defenses and Systemic Acquires Resistance (SAR) \{sar-litrev\}}\label{plant-defenses-and-systemic-acquires-resistance-sar-sar-litrev}}

  Cecidomyiidae feed on \emph{Phyllocoptruta oleivora} (Villanueva et al. 2006)

  \emph{Amblyseius victoriensis} control of \emph{Tegolophus australis} and \emph{Phyllocoptruta oleivora} Smith and Papacek (1991)
  ...
  Rose Rosette Virus (RRV), the casual agent of Rose Rosette Disease (RRD) and \emph{P. fructiphilus} Kiefer invaded the southeastern United States on the multiflora rose, \emph{R. multiflora} (Thunb) as it spread its range towards the coast (Amrine Jr 2002, Otero-Colina et al. 2018). RRD is present throughout the US, including Decatur County, GA, near the Florida border (\emph{Figure 3}), (EDDMapS 2019).

  \includegraphics[width=3.47in]{figure/reed}

  Figure 3: Map of the distribution of Rose Rosette Disease (RRD) in 2019 as reported from the Early Detection \& Distribution Mapping System maintained by the University of Georgia's Center for Invasive Species and Ecosystem Health. Areas in green are counties where RRD has been reported.
  ...
  An additional value of rose surveys will be detecting other mites present on roses: there are many species of predatory phytoseiid mites present in Florida with potential to control agricultural pests such as \emph{P. fructiphilus}. Native predatory mites sometimes have an advantage for bio-control because native mites have adapted to the environment where they will be released. Besides predatory mites, we also may encounter other alternative vectors of RRV or different mite species of concern which have not yet been reported in Florida.
...
\end{verbatim}
  ...
  Figure 14: Field design for Integrated Pest Management trials on Pink Double Knock Out® roses to control \emph{P. fructiphilus} in Griffin, GA with five treatments. W = Water A = Actigard50WG, K = Kontos, M = \emph{A. swirkii} predatory mite sachets, N = SP2700 (Trade name: Ninja, SePro), + = \emph{A. swirskii} + Ninja combined treatments. All products were applied at their label rates for 12 weeks. Flower cuttings were taken weekly to record \emph{P. fructiphilus} numbers.
  \begin{center}\includegraphics[width=0.8\linewidth]{figure/rrv_ipm_plot_map_2019_griffin} \end{center}

  Figure 15: Field design for Integrated Pest Management trials on Pink Double Knock Out® roses to control \emph{P. fructiphilus} in Tallahassee, FL with five treatments: Water, Actigard50WG, Kontos, \emph{Amblyseius swirkii} predatory mite sachets, and \emph{A. swirskii} + Actigard combined treatments. All products were applied at their label rates for 12 weeks. Flower cuttings were taken weekly to record \emph{P. fructiphilus} numbers.

  \includegraphics[width=3.47in]{figure/reed}

  Figure 16: Number of \emph{Phyllocoptes fructiphilus} found in rose samples with five treatments. Statistical significance was determined using Tukey contrasts for multiple Comparisons of means. Groups which share letters are not statistically different from one another. a = 0.05
  ...
  *Corresponding author; E-mail: xmartini@ufl.edu Phone: 850-875-7160 Fax: 352-846-6617
  ...
  Figure 17: Variety of symptoms seen on \emph{Liriope} spp. infected with orchid fleck virus (OFV): (a) symptoms on \emph{Liriope muscari} cv. `Gigantea' (b-c) Details of symptoms on \emph{L. muscari} cv. `Gigantea' (d) rust colored spots on \emph{Ophiopogon intermedius}

  Figure 18: Symptoms seen on \emph{Aspidistra elatior} infected with OFV: (a) Detail of leaf chlorosis (b) Chlorosis appears similar to sun damage (c-d) Chlorotic flecks may indicate early symptoms of OFV

  Figure 19: Cryo-SEM images of \emph{Brevipalpus californicus} \emph{sensu lato} displaying various characters used for identification (Baker and Tuttle 1987, Beard et al. 2015) (a) Dorsum (b) Lateral view (c) Venter (d) Close up of distal end of leg 2, with arrows indicating paired solenidia, characteristic of the genus \emph{Brevipalpus} (e) Enlargement of the microplates of the mite cerotegument (f) Dorsal view of the distal portion of mite abdomen (g) Dorsal view of the mite rostrum (h) Ventral view of mite rostrum, observe 3 distal setae.
  ...
  \textbf{Gadino, A. N., V. M. Walton, and J. C. Lee}. \textbf{2011}. Olfactory response of \emph{{T}yphlodromus pyri} {({Acari}: {Phytoseiidae})} to synthetic methyl salicylate in laboratory bioassays. Journal of Applied Entomology. 136: 476--480, DOI:\href{https://doi.org/10.1111/j.1439-0418.2011.01670.x}{10.1111/j.1439-0418.2011.01670.x}.
  ...
  \textbf{Pérez, F. F., I. P. Moreno, V. M. I. Calvo, and L. A. E. Colomar}. \textbf{2010}. {Á}caros depredadores de la familia {Phytoseiidae} en las plantas cultivadas. Ediciones Agrot{é}cnicas, Madrid.
  ...
  \leavevmode\vadjust pre{\hypertarget{ref-Villanueva2006}{}}%
  \textbf{Villanueva, R. T., R. Gagné, and C. C. Childers}. \textbf{2006}. Two species of {Cecidomyiidae} predacious on citrus rust mite, {\emph{Phyllocoptruta oleivora}}, on {Florida} citrus. Florida Entomologist. 161--167.
