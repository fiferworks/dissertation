...
%this adds a header which says 'CHAPTER' to the toc
  ...
  \hypertarget{survey}{%
  \chapter{\texorpdfstring{Survey for the invasive mite \emph{Phyllocoptes fructiphilus}, Rose Rosette Virus (RRV), and wild predatory mites in northern Florida}{Survey for the invasive mite Phyllocoptes fructiphilus, Rose Rosette Virus (RRV), and wild predatory mites in northern Florida}}\label{survey}}

  \hypertarget{survey-nfl}{%
  \section{Introduction}\label{survey-nfl}}
  ...
  \hypertarget{surveying-for-p.-fructiphilus-rrd-and-predatory-mites-florida}{%
  \section{\texorpdfstring{Surveying for \emph{P. fructiphilus}, RRD and predatory mites Florida}{Surveying for P. fructiphilus, RRD and predatory mites Florida}}\label{surveying-for-p.-fructiphilus-rrd-and-predatory-mites-florida}}
  ...
  425 samples were taken from 33 cites from an east to west transect along the border northern Florida. \emph{P. fructiphilus} mites were recovered in rose samples from six cities: Baldwin, Defuniak Springs, Gainesville, Jacksonville and Tallahassee. Other mites were collected from 68\% of the cities visited. \emph{P. fructiphilus} per sample were low on average, but abundant in individual samples. No evidence of RRD was observed in northern Florida. Many other mites were collected, including a number of predatory mites which await identification.
  ...
  \multicolumn{11}{l}{\rule{0pt}{1em}Eriophyids and other mites recovered during surveys of roses in Florida, 2017-2021.}\\
  \end{tabular}}
  \end{table}
